...
import com.docplatform.vector.service.ChunkPreviewService;
...
public class IndexAdminController {
    ...
    public IndexAdminController(IndexingService indexingService, ChunkPreviewService chunkPreviewService) {
    ...
    public void purge(@PathVariable UUID docId) {
        indexingService.delete(com.docplatform.event.DocumentDeletedEvent.create(docId, "admin", 0));
    }
}
